...
`Lanhu Context MCP` turns a single Lanhu design into context for AI to generate code and recreate pages.
...
If you are familiar with `Figma MCP`, the rough mental model is similar: instead of handing AI the code directly, you first organize design data into context for AI to generate code and recreate pages, then continue into implementation.
...
- the output is design context for code generation and page recreation, not a direct replacement for production code
